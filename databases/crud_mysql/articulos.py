...
class FormularioArticulos:
    ...
    def consultar(self):
        ...
        respuesta = self.articulo1.consulta_articulo(datos)# query a la BBDD
    ...
    def listar(self):
        respuesta = self.articulo1.consultar_todos()
    ...
    def borrar(self):
        ...
        cantidad = self.articulo1.quitar_articulo(datos)
    ...
    def modifica(self):
        ...
        cantidad = self.articulo1.modificar_articulo(datos)
        if cantidad == 1:
    ...
    def consultar_mod(self):
        ...
        respuesta = self.articulo1.consulta_articulo(datos)
        if len(respuesta) > 0:
